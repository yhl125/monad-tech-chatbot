...
export const introduction: Document<Record<string, any>> = {
  ...
  pageContent: `Monad is a high-performance Ethereum-compatible L1.  Monad materially advances the efficient frontier in the tradeoff between decentralization and scalability.
